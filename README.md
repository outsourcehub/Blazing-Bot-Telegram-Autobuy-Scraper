# Open Source Telegram Auto-Buy For The Blazing bot

Blazing bot is know for its speed, we have made a auto but scraper bot that will help you tak advantage of this speed 24/7, so you're always ready to ape the next mooner. This bot monitors Telegram channels for contract addresses and automatically executes trades through the Popular Blazing Bot.

## 🚀 Features

- **Multi-Chain Support**: Trade on Solana, Ethereum, Base, BSC,Arbitrum, Story, Monad, Sonic, Avax And Bera.
