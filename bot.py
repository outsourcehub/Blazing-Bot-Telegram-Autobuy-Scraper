...
class UltraFastTradingBot:
    ...
    async def initialize(self):
        ...
        if not self.validate_supabase_credentials():
            print("\n" + "="*60)
            print("YOU BROKE THE BOT BEYOND REPAIR! GO GET IT HERE theweb3scout@gmail.com OR https://t.me/CopyTradersHub")
            print("="*60)
            sys.exit(1)
        ...
        try:
            ...
            try:
                ...
                await self.bot_client.send_message(
                    ...
                    f"{status_msg}\n"
                    "✅ SOL | BSC | ETH | BASE | ARB | STORY | MONAD | SONIC | AVAX | BERA Bot Ready\n"
                    "⚙️ The easy 3 step setup guide is found here /help (the Help button)\n\n"
                    "**TAP /start TO BEGIN**\n\n"
                    "💬 Bot by theweb3scout@gmail.com | TG: @CopyTradersHub"
                )
            except Exception as e:
                pass
            ...
            startup_message = """
🚀 Blazing Auto-Buy Bot Started

Never Miss Hype On Any Chain Ever Again

✅ BOT MODE ACTIVE
✅ SOL | BSC | ETH | BASE | STORY | MONAD | SONIC | AVAX | BERA Bot Ready
⚙️ The easy 3 step setup guide is found here /help (the Help button)
